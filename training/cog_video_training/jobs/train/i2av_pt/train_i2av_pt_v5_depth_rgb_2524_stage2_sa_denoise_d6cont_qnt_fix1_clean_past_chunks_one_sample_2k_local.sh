...
export COAF_PATH_REMAP_FROM="${COAF_PATH_REMAP_FROM:-/project/mscaisuperpod/sunkai/Casual_CoAF}"
...
SRC_DATA_ROOT="${DATASET_ROOT}/composed/v4_depth_rgb"
TINY_DATA_ROOT="${DATASET_ROOT}/composed/v4_depth_rgb_one_sample_overfit_clean_past_chunks"
export SRC_DATA_ROOT TINY_DATA_ROOT
...
export OUTPUT_DIR="${CASUAL_ROOT}/outputs/checkpoints/i2av/v5_depth_rgb_2524_stage2_sa_denoise_d6cont_qnt_fix1_clean_past_chunks_one_sample_2k"
...
export TRACKER_NAME=casual-coaf-i2av-pt-v5-depth-rgb-2524-stage2-sa-denoise-d6cont-qnt-fix1-clean-past-chunks-one-sample
...
nvidia-smi || true
bash "${CASUAL_ROOT}/scripts/train_cogvideox_i2av_lora_causal.sh" 2>&1 | tee "${CASUAL_ROOT}/logs/train/i2av_pt/local_qnt_fix1_clean_past_chunks_one_sample_$(date +%Y%m%d_%H%M%S).log"
